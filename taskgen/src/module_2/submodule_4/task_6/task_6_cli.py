...
from .task_6 import Module2_Submodule4_Task6


def _factory(args):
    return Module2_Submodule4_Task6(seed=args.seed)
...
Module2_Submodule4_Task6_CLIParser = CLIParser(
    name="module_2.submodule_4.task_6",
