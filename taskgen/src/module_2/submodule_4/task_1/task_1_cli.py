...
from .task_1 import Module2_Submodule4_Task1


def _factory(args):
    return Module2_Submodule4_Task1(seed=args.seed)
...
Module2_Submodule4_Task1_CLIParser = CLIParser(
    name="module_2.submodule_4.task_1",
