...
from .task_2 import Module2_Submodule4_Task2


def _factory(args):
    return Module2_Submodule4_Task2(seed=args.seed)
...
Module2_Submodule4_Task2_CLIParser = CLIParser(
    name="module_2.submodule_4.task_2",
