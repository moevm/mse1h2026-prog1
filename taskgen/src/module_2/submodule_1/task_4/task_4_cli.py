...
from .task_4 import Module2_Submodule1_Task4


def _factory(args):
    return Module2_Submodule1_Task4(seed=args.seed)
...
Module2_Submodule1_Task4_CLIParser = CLIParser(
    name="module_2.submodule_1.task_4",
