...
from .task_1 import Module2_Submodule1_Task1


def _factory(args):
    return Module2_Submodule1_Task1(seed=args.seed)
...
Module2_Submodule1_Task1_CLIParser = CLIParser(
    name="module_2.submodule_1.task_1",
