...
from .task_5 import Module2_Submodule1_Task5


def _factory(args):
    return Module2_Submodule1_Task5(seed=args.seed)
...
Module2_Submodule1_Task5_CLIParser = CLIParser(
    name="module_2.submodule_1.task_5",
