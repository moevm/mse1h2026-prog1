...
from .task_10 import Module2_Submodule2_Task10


def _factory(args):
    return Module2_Submodule2_Task10(seed=args.seed)
...
Module2_Submodule2_Task10_CLIParser = CLIParser(
    name="module_2.submodule_2.task_10",
