...
from .task_12 import Module2_Submodule2_Task12


def _factory(args):
    return Module2_Submodule2_Task12(seed=args.seed)
...
Module2_Submodule2_Task12_CLIParser = CLIParser(
    name="module_2.submodule_2.task_12",
