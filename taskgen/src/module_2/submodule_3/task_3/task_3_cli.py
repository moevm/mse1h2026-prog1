...
from .task_3 import Module2_Submodule3_Task3


def _factory(args):
    return Module2_Submodule3_Task3(seed=args.seed)
...
Module2_Submodule3_Task3_CLIParser = CLIParser(
    name="module_2.submodule_3.task_3",
