...
from .task_5 import Module_1_Submodule_3_task_5


def create_task_test(args) -> Module_1_Submodule_3_task_5:
    task = Module_1_Submodule_3_task_5(
...
Module_1_Submodule_3_task_5_CLI_Parser = CLIParser(
    name="module_1.submodule_3.task_5",
