...
from .task_6 import Module_1_Submodule_8_task_6


def create_task_limits(args) -> Module_1_Submodule_8_task_6:
    return Module_1_Submodule_8_task_6(**get_common_cli_args(args))
...
Module_1_Submodule_8_task_6_CLI_Parser = CLIParser(
    name="module_1.submodule_8.task_6",
