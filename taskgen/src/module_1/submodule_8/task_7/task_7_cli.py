...
from .task_7 import Module_1_Submodule_8_task_7


def create_task_limits(args) -> Module_1_Submodule_8_task_7:
    return Module_1_Submodule_8_task_7(**get_common_cli_args(args))
...
Module_1_Submodule_8_task_7_CLI_Parser = CLIParser(
    name="module_1.submodule_8.task_7",
