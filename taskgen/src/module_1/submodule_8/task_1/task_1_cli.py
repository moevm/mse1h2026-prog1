...
def create_task_test(args) -> Module_1_Submodule_8_task_1:
    task = Module_1_Submodule_8_task_1(
...
Module_1_Submodule_8_task_1_CLI_Parser = CLIParser(
    name="module_1.submodule_8.task_1",
