...
from .task_3 import Module_1_Submodule_8_task_3


def create_task_limits(args) -> Module_1_Submodule_8_task_3:
    return Module_1_Submodule_8_task_3(**get_common_cli_args(args))
...
Module_1_Submodule_8_task_3_CLI_Parser = CLIParser(
    name="module_1.submodule_8.task_3",
