...
from .task_3 import Module_1_Submodule_5_task_3


def create_task_test(args) -> Module_1_Submodule_5_task_3:
    task = Module_1_Submodule_5_task_3(
...
Module_1_Submodule_5_task_3_CLI_Parser = CLIParser(
    name="module_1.submodule_5.task_3",
