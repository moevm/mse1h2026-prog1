...
from .task_9 import Module_1_Submodule_5_task_9


def create_task_limits(args) -> Module_1_Submodule_5_task_9:
    return Module_1_Submodule_5_task_9(**get_common_cli_args(args))
...
Module_1_Submodule_5_task_9_CLI_Parser = CLIParser(
    name="module_1.submodule_5.task_9",
