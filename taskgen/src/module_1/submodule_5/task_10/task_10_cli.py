...
from .task_10 import Module_1_Submodule_5_task_10


def create_task_limits(args) -> Module_1_Submodule_5_task_10:
    return Module_1_Submodule_5_task_10(**get_common_cli_args(args))
...
Module_1_Submodule_5_task_10_CLI_Parser = CLIParser(
    name="module_1.submodule_5.task_10",
