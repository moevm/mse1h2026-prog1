...
from .task_6 import Module_1_Submodule_5_task_6


def create_task_test(args) -> Module_1_Submodule_5_task_6:
    task = Module_1_Submodule_5_task_6(
...
Module_1_Submodule_5_task_6_CLI_Parser = CLIParser(
    name="module_1.submodule_5.task_6",
