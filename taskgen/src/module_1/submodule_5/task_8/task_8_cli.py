...
from .task_8 import Module_1_Submodule_5_task_8


def create_task_test(args) -> Module_1_Submodule_5_task_8:
    task = Module_1_Submodule_5_task_8(
...
Module_1_Submodule_5_task_8_CLI_Parser = CLIParser(
    name="module_1.submodule_5.task_8",
