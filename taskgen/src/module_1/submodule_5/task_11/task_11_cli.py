...
from .task_11 import Module_1_Submodule_5_task_11


def create_task_test(args) -> Module_1_Submodule_5_task_11:
    task = Module_1_Submodule_5_task_11(
...
Module_1_Submodule_5_task_11_CLI_Parser = CLIParser(
    name="module_1.submodule_5.task_11",
