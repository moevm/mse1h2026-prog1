...
from .task_4 import Module_1_Submodule_7_task_4


def create_task_limits(args) -> Module_1_Submodule_7_task_4:
    return Module_1_Submodule_7_task_4(**get_common_cli_args(args))
...
Module_1_Submodule_7_task_4_CLI_Parser = CLIParser(
    name="module_1.submodule_7.task_4",
