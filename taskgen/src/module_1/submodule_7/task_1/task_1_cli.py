...
from .task_1 import Module_1_Submodule_7_task_1


def create_task_limits(args) -> Module_1_Submodule_7_task_1:
    return Module_1_Submodule_7_task_1(**get_common_cli_args(args))
...
Module_1_Submodule_7_task_1_CLI_Parser = CLIParser(
    name="module_1.submodule_7.task_1",
