...
from .task_8 import Module_1_Submodule_6_task_8


def create_task_limits(args) -> Module_1_Submodule_6_task_8:
    return Module_1_Submodule_6_task_8(**get_common_cli_args(args))
...
Module_1_Submodule_6_task_8_CLI_Parser = CLIParser(
    name="module_1.submodule_6.task_8",
