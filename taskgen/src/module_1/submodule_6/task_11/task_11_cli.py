...
from .task_11 import Module_1_Submodule_6_task_11


def create_task_limits(args) -> Module_1_Submodule_6_task_11:
    return Module_1_Submodule_6_task_11(**get_common_cli_args(args))
...
Module_1_Submodule_6_task_11_CLI_Parser = CLIParser(
    name="module_1.submodule_6.task_11",
