...
from .task_5 import Module_1_Submodule_6_task_5


def create_task_limits(args) -> Module_1_Submodule_6_task_5:
    return Module_1_Submodule_6_task_5(**get_common_cli_args(args))
...
Module_1_Submodule_6_task_5_CLI_Parser = CLIParser(
    name="module_1.submodule_6.task_5",
