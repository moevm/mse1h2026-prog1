...
def create_task_test(args) -> Module_1_Submodule_6_task_1:
    task = Module_1_Submodule_6_task_1(
...
Module_1_Submodule_6_task_1_CLI_Parser = CLIParser(
    name="module_1.submodule_6.task_1",
