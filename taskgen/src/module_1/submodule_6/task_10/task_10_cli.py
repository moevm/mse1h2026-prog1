...
from .task_10 import Module_1_Submodule_6_task_10


def create_task_test(args) -> Module_1_Submodule_6_task_10:
    task = Module_1_Submodule_6_task_10(
...
Module_1_Submodule_6_task_10_CLI_Parser = CLIParser(
    name="module_1.submodule_6.task_10",
