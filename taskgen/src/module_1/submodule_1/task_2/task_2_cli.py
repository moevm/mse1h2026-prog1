...
from .task_2 import Module_1_Submodule_1_task_2


def create_task_test(args) -> Module_1_Submodule_1_task_2:
    task = Module_1_Submodule_1_task_2(
...
Module_1_Submodule_1_task_2_CLI_Parser = CLIParser(
    name="module_1.submodule_1.task_2",
