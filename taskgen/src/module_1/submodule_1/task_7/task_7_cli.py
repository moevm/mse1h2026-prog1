...
from .task_7 import Module_1_Submodule_1_task_7


def create_task_test(args) -> Module_1_Submodule_1_task_7:
    task = Module_1_Submodule_1_task_7(
...
Module_1_Submodule_1_task_7_CLI_Parser = CLIParser(
    name="module_1.submodule_1.task_7",
