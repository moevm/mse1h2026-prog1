...
from .task_2 import Module_1_Submodule_4_task_2


def create_task_limits(args) -> Module_1_Submodule_4_task_2:
    return Module_1_Submodule_4_task_2(**get_common_cli_args(args))
...
Module_1_Submodule_4_task_2_CLI_Parser = CLIParser(
    name="module_1.submodule_4.task_2",
