...
from .task_4 import Module_1_Submodule_2_task_4


def create_task_test(args) -> Module_1_Submodule_2_task_4:
    task = Module_1_Submodule_2_task_4(
...
Module_1_Submodule_2_task_4_CLI_Parser = CLIParser(
    name="module_1.submodule_2.task_4",
