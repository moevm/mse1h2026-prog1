...
from .task_15 import Module_1_Submodule_2_task_15


def create_task_limits(args) -> Module_1_Submodule_2_task_15:
    return Module_1_Submodule_2_task_15(**get_common_cli_args(args))
...
Module_1_Submodule_2_task_15_CLI_Parser = CLIParser(
    name="module_1.submodule_2.task_15",
