...
from .task_12 import Module_1_Submodule_2_task_12


def create_task_limits(args) -> Module_1_Submodule_2_task_12:
    return Module_1_Submodule_2_task_12(**get_common_cli_args(args))
...
Module_1_Submodule_2_task_12_CLI_Parser = CLIParser(
    name="module_1.submodule_2.task_12",
