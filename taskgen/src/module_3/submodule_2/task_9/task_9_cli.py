...
def create_task_1(args) -> Module3_Submodule2_Task9:
    task = Module3_Submodule2_Task9(
...
Module3_Submodule2_Task9CLIParser = CLIParser(
    name="module_3.submodule_2.task_9", 
