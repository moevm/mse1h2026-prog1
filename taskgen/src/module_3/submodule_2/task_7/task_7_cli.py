...
from .task_7 import Module3_Submodule2_Task7  

def create_task_1(args) -> Module3_Submodule2_Task7:
    task = Module3_Submodule2_Task7(
...
Module3_Submodule2_Task7CLIParser = CLIParser(
    name="module_3.submodule_2.task_7", 
