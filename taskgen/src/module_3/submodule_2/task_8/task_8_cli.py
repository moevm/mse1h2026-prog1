...
from .task_8 import Module3_Submodule2_Task8  

def create_task_1(args) -> Module3_Submodule2_Task8:
    task = Module3_Submodule2_Task8(
...
Module3_Submodule2_Task8CLIParser = CLIParser(
    name="module_3.submodule_2.task_8", 
