...
from .task_6 import Module3_Submodule5_Task6 

def create_task_1(args) -> Module3_Submodule5_Task6:
    task = Module3_Submodule5_Task6(
...
Module3_Submodule5_Task6CLIParser = CLIParser(
    name="module_3.submodule_5.task_6", 
