...
from .task_11 import Module3_Submodule5_Task11 

def create_task_1(args) -> Module3_Submodule5_Task11:
    task = Module3_Submodule5_Task11(
...
Module3_Submodule5_Task11CLIParser = CLIParser(
    name="module_3.submodule_5.task_11", 
