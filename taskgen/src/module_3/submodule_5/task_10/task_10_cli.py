...
from .task_10 import Module3_Submodule5_Task10 

def create_task_1(args) -> Module3_Submodule5_Task10:
    task = Module3_Submodule5_Task10(
...
Module3_Submodule5_Task10CLIParser = CLIParser(
    name="module_3.submodule_5.task_10", 
