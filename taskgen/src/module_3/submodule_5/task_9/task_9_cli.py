...
from .task_9 import Module3_Submodule5_Task9 

def create_task_1(args) -> Module3_Submodule5_Task9:
    task = Module3_Submodule5_Task9(
...
Module3_Submodule5_Task9CLIParser = CLIParser(
    name="module_3.submodule_5.task_9", 
