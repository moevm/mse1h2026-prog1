...
from .task_4 import Module3_Submodule5_Task4

def create_task_1(args) -> Module3_Submodule5_Task4:
    task = Module3_Submodule5_Task4(
...
Module3_Submodule5_Task4CLIParser = CLIParser(
    name="module_3.submodule_5.task_4", 
