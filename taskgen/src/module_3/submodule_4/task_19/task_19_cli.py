...
from .task_19 import Module3_Submodule4_Task19

def create_task_1(args) -> Module3_Submodule4_Task19:
    task = Module3_Submodule4_Task19(
...
Module3_Submodule4_Task19CLIParser = CLIParser(
    name="module_3.submodule_4.task_19", 
