...
from .task_13 import Module3_Submodule4_Task13

def create_task_1(args) -> Module3_Submodule4_Task13:
    task = Module3_Submodule4_Task13(
...
Module3_Submodule4_Task13CLIParser = CLIParser(
    name="module_3.submodule_4.task_13", 
