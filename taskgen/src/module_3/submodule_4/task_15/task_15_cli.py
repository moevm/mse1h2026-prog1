...
from .task_15 import Module3_Submodule4_Task15

def create_task_1(args) -> Module3_Submodule4_Task15:
    task = Module3_Submodule4_Task15(
...
Module3_Submodule4_Task15CLIParser = CLIParser(
    name="module_3.submodule_4.task_15", 
