...
TASK_DESCRIPTION = "Какая функция соответствует описанию: сравнивает cs и ct; возвращает <0, если cs<ct, 0, если cs==ct, и >0, если cs>ct?"

class Module3_Submodule4_Task11(BaseTaskClass):
