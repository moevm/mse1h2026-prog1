...
from .task_14 import Module3_Submodule4_Task14

def create_task_1(args) -> Module3_Submodule4_Task14:
    task = Module3_Submodule4_Task14(
...
Module3_Submodule4_Task14CLIParser = CLIParser(
    name="module_3.submodule_4.task_14", 
