...
from .task_6 import Module3_Submodule4_Task6

def create_task_1(args) -> Module3_Submodule4_Task6:
    task = Module3_Submodule4_Task6(
...
Module3_Submodule4_Task6CLIParser = CLIParser(
    name="module_3.submodule_4.task_6", 
