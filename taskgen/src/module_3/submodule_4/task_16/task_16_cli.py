...
from .task_16 import Module3_Submodule4_Task16

def create_task_1(args) -> Module3_Submodule4_Task16:
    task = Module3_Submodule4_Task16(
...
Module3_Submodule4_Task16CLIParser = CLIParser(
    name="module_3.submodule_4.task_16", 
