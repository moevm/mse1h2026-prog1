...
from .task_22 import Module3_Submodule4_Task22

def create_task_1(args) -> Module3_Submodule4_Task22:
    task = Module3_Submodule4_Task22(
...
Module3_Submodule4_Task22CLIParser = CLIParser(
    name="module_3.submodule_4.task_22", 
