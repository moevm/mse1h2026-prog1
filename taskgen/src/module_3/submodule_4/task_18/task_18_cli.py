...
from .task_18 import Module3_Submodule4_Task18

def create_task_1(args) -> Module3_Submodule4_Task18:
    task = Module3_Submodule4_Task18(
...
Module3_Submodule4_Task18CLIParser = CLIParser(
    name="module_3.submodule_4.task_18", 
