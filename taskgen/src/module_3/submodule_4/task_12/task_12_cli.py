...
from .task_12 import Module3_Submodule4_Task12

def create_task_1(args) -> Module3_Submodule4_Task12:
    task = Module3_Submodule4_Task12(
...
Module3_Submodule4_Task12CLIParser = CLIParser(
    name="module_3.submodule_4.task_12", 
