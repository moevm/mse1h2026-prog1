...
from .task_21 import Module3_Submodule4_Task21

def create_task_1(args) -> Module3_Submodule4_Task21:
    task = Module3_Submodule4_Task21(
...
Module3_Submodule4_Task21CLIParser = CLIParser(
    name="module_3.submodule_4.task_21", 
