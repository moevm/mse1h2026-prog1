...
from .task_17 import Module3_Submodule4_Task17

def create_task_1(args) -> Module3_Submodule4_Task17:
    task = Module3_Submodule4_Task17(
...
Module3_Submodule4_Task17CLIParser = CLIParser(
    name="module_3.submodule_4.task_17", 
