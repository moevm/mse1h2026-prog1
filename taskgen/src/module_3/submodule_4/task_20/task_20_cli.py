...
from .task_20 import Module3_Submodule4_Task20

def create_task_1(args) -> Module3_Submodule4_Task20:
    task = Module3_Submodule4_Task20(
...
Module3_Submodule4_Task20CLIParser = CLIParser(
    name="module_3.submodule_4.task_20", 
