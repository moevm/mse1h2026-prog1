...
from .task_8 import Module3_Submodule4_Task8

def create_task_1(args) -> Module3_Submodule4_Task8:
    task = Module3_Submodule4_Task8(
...
Module3_Submodule4_Task8CLIParser = CLIParser(
    name="module_3.submodule_4.task_8", 
