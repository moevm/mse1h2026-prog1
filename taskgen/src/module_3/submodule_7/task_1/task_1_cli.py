...
from .task_1 import Module3_Submodule7_Task1  

def create_task_1(args) -> Module3_Submodule7_Task1:
    task = Module3_Submodule7_Task1(
...
Module3_Submodule7_Task1CLIParser = CLIParser(
    name="module_3.submodule_7.task_1", 
