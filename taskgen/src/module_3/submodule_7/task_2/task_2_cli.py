...
from .task_2 import Module3_Submodule7_Task2  

def create_task_1(args) -> Module3_Submodule7_Task2:
    task = Module3_Submodule7_Task2(
...
Module3_Submodule7_Task2CLIParser = CLIParser(
    name="module_3.submodule_7.task_2", 
