...
from .task_3 import Module3_Submodule1_Task3

def create_task_1(args) -> Module3_Submodule1_Task3:
    task = Module3_Submodule1_Task3(
...
Module3_Submodule1_Task3CLIParser = CLIParser(
    name="module_3.submodule_1.task_3", 
