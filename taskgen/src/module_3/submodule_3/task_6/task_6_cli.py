...
from .task_6 import Module3_Submodule3_Task6  

def create_task_1(args) -> Module3_Submodule3_Task6:
    task = Module3_Submodule3_Task6(
...
Module3_Submodule3_Task6CLIParser = CLIParser(
    name="module_3.submodule_3.task_6", 
