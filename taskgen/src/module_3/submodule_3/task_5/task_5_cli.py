...
from .task_5 import Module3_Submodule3_Task5  

def create_task_1(args) -> Module3_Submodule3_Task5:
    task = Module3_Submodule3_Task5(
...
Module3_Submodule3_Task5CLIParser = CLIParser(
    name="module_3.submodule_3.task_5", 
