...
def create_task_system(args) -> SystemTask:
    return SystemTask(**get_common_cli_args(args))


def add_cli_args_system(parser: argparse.ArgumentParser):
    ...
    parser.set_defaults(func=create_task_system)


SystemCLIParser = CLIParser(
    name="system",
    add_cli_args=add_cli_args_system,
)