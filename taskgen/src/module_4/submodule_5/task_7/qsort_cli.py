...
def create_task_qsort(args) -> QsortTask:
    return QsortTask(**get_common_cli_args(args))


def add_cli_args_qsort(parser: argparse.ArgumentParser):
    ...
    parser.set_defaults(func=create_task_qsort)


QsortCLIParser = CLIParser(
    name="qsort",
    add_cli_args=add_cli_args_qsort,
)