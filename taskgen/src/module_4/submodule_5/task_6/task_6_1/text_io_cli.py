...
from .text_io_task import TextIOTask


def create_task_text_io(args) -> TextIOTask:
    return TextIOTask(**get_common_cli_args(args))


def add_cli_args_text_io(parser: argparse.ArgumentParser):
    ...
    parser.set_defaults(func=create_task_text_io)


TextIOCLIParser = CLIParser(
    name="text_io",
    add_cli_args=add_cli_args_text_io,
)