...
from .fopen_task import FOpenTask


def create_task_fopen(args) -> FOpenTask:
    return FOpenTask(**get_common_cli_args(args))


def add_cli_args_fopen(parser: argparse.ArgumentParser):
    ...
    parser.set_defaults(func=create_task_fopen)


FOpenCLIParser = CLIParser(
    name="fopen",
    add_cli_args=add_cli_args_fopen,
)