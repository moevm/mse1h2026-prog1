...
def create_task_bsearch(args) -> BsearchTask:
    return BsearchTask(**get_common_cli_args(args))


def add_cli_args_bsearch(parser: argparse.ArgumentParser):
    ...
    parser.set_defaults(func=create_task_bsearch)


BsearchCLIParser = CLIParser(
    name="bsearch",
    add_cli_args=add_cli_args_bsearch,
)