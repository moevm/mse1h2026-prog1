...
def create_task_struct_access(args) -> StructAccessTask:
    return StructAccessTask(**get_common_cli_args(args))

def add_cli_args_struct_access(parser: argparse.ArgumentParser):
    ...
    parser.set_defaults(func=create_task_struct_access)

StructAccessCLIParser = CLIParser(
    name="struct_access",
    add_cli_args=add_cli_args_struct_access,
)