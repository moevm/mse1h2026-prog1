...
def create_task_struct_compute(args) -> StructComputeTask:
    return StructComputeTask(**get_common_cli_args(args))


def add_cli_args_struct_compute(parser: argparse.ArgumentParser):
    ...
    parser.set_defaults(func=create_task_struct_compute)


StructComputeCLIParser = CLIParser(
    name="struct_compute",
    add_cli_args=add_cli_args_struct_compute,
)