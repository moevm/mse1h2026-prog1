...
Подмодуль содержит 7 заданий по работе со структурами. Первые три задания реализованы программно (на момент окончания итерации 2).
...
## Запуск автоматизированных заданий (1–3)
...
Пока не имеют автоматической проверки. Ответы зависят от `seed` и приведены в описании заданий.
