...
from .perror_task import PerrorTask


def create_task_perror(args) -> PerrorTask:
    return PerrorTask(**get_common_cli_args(args))


def add_cli_args_perror(parser: argparse.ArgumentParser):
    ...
    parser.set_defaults(func=create_task_perror)


PerrorCLIParser = CLIParser(
    name="perror",
    add_cli_args=add_cli_args_perror,
)